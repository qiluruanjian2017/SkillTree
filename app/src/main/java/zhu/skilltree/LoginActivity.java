...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                bounds.addListener(new Transition.TransitionListener() {
                    ...
                    public void onTransitionStart(Transition transition) {
                        ...
                        ObjectAnimator animator4 = ObjectAnimator.ofFloat(username, "alpha", 1, 0);
                        ...
                        ObjectAnimator animator9 = ObjectAnimator.ofFloat(username2, "alpha", 0, 1);
            ...
            public void onClick(View view) {
                ...
                bounds.addListener(new Transition.TransitionListener() {
                    ...
                    public void onTransitionStart(Transition transition) {
                        ...
                        ObjectAnimator animator4 = ObjectAnimator.ofFloat(username, "alpha", 0, 1);
                        ...
                        ObjectAnimator animator9 = ObjectAnimator.ofFloat(username2, "alpha", 1, 0);
        ...
        if (bmobUser != null) {
            Snackbar.make(relativeLayout2, "请稍候...", Snackbar.LENGTH_SHORT).show();
    ...
    private Boolean login() {
        ...
        bu2.setPassword(pass.getText().toString());
        bu2.login(new SaveListener<BmobUser>() {
            ...
            public void done(BmobUser bmobUser, BmobException e) {
                if (e == null) {
                    ...
                    Snackbar.make(relativeLayout2, "登录失败..." + e.toString(), Snackbar.LENGTH_SHORT).show();
                }
            }
        });
        return true;
    ...
    private Boolean signUp() {
        ...
        bu.setUsername(username2.getText().toString());
        bu.setPassword(pass2.getText().toString());
        bu.signUp(new SaveListener<BmobUser>() {
            @Override
            public void done(BmobUser s, BmobException e) {
                if (e == null) {
                    Snackbar.make(relativeLayout2, "注册成功..." + e.toString(), Snackbar.LENGTH_SHORT).show();

                    startActivity(new Intent(LoginActivity.this, MainActivity.class));
                } else {
                    Snackbar.make(relativeLayout2, "注册失败..." + e.toString(), Snackbar.LENGTH_SHORT).show();
                }
            }
        });
        return true;
