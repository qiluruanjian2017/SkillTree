...
public class MyActivityAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final MyActivity myActivity = mList.get(position);
        ...
        mholder.select.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                MyActivity temp=new MyActivity(activity.getName(),activity.getOrganizer());
                Log.d("bmob", "act:"+activity.getName()+activity.getOrganizer()+activity.getStatus()+activity.getObjectId());
                temp.setStatus("doing");
                temp.update(activity.getObjectId(), new UpdateListener() {
                    @Override
